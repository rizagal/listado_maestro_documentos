        ...
        <tr>
            <td>
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" 
                    DataSourceID="SqlDataSource_listado" KeyFieldName="id_sgd" OnInitNewRow="initlistado"
                    CssFilePath="~/App_Themes/Office2003Blue/{0}/styles.css" OnHtmlEditFormCreated="edi_lista" 
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="titulo_formato" VisibleIndex="7">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox_titulo" runat="server" Height="50px" 
                                    Text='<%# Bind("titulo_formato") %>' TextMode="MultiLine" Width="200px"></asp:TextBox>
                            </EditItemTemplate>
                            <HeaderTemplate>
                        ...
                        <dx:GridViewDataDateColumn FieldName="fecha_emision" VisibleIndex="9">
                            ...
                            <EditItemTemplate>
                                <dx:ASPxDateEdit ID="ASPxDateEdit_fecha" runat="server" 
                                    Value='<%# Bind("fecha_emision") %>' Width="100px">
                                </dx:ASPxDateEdit>
                            </EditItemTemplate>
                            <HeaderTemplate>
                                <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="Black" 
...
<RegularExpression ErrorText="Fall&#243; la validaci&#243;n de expresi&#243;n Regular"></RegularExpression>
                        ...
                        <dx:GridViewBandColumn Caption="CODIGO" VisibleIndex="5">
                            <Columns>
                                ...
                                <dx:GridViewDataComboBoxColumn Caption="UNIDAD" FieldName="codigo_unidad" 
                                    VisibleIndex="1">
                                    <PropertiesComboBox>
                                        <Items>
                                            <dx:ListEditItem Text="GSC" Value="GSC" />
                                            <dx:ListEditItem Text="CIR" Value="CIR" />
                                            <dx:ListEditItem Text="CPT" Value="CPT" />
                                            <dx:ListEditItem Text="ASO" Value="ASO" />
                                            <dx:ListEditItem Text="CGE" Value="CGE" />
                                            <dx:ListEditItem Text="SFC" Value="SFC" />
                                            <dx:ListEditItem Text="AIM" Value="AIM" />
                                            <dx:ListEditItem Text="AIN" Value="AIN" />
                                            <dx:ListEditItem Text="SSR" Value="SSR" />
                                            <dx:ListEditItem Text="AEC" Value="AEC" />
                                            <dx:ListEditItem Text="PSI" Value="PSI" />
                                            <dx:ListEditItem Text="TEL" Value="TEL" />
                                            <dx:ListEditItem Text="URG" Value="URG" />
                                            <dx:ListEditItem Text="APD" Value="APD" />
                                            <dx:ListEditItem Text="GAM" Value="GAM" />
                                            <dx:ListEditItem Text="FAR" Value="FAR" />
                                            <dx:ListEditItem Text="CYA" Value="CYA" />
                                            <dx:ListEditItem Text="GFI" Value="GFI" />
                                            <dx:ListEditItem Text="RYF" Value="RYF" />
                                            <dx:ListEditItem Text="SIS" Value="SIS" />
                                            <dx:ListEditItem Text="GDO" Value="GDO" />
                                            <dx:ListEditItem Text="GBI" Value="GBI" />
                                            <dx:ListEditItem Text="JUR" Value="JUR" />
                                            <dx:ListEditItem Text="IYD" Value="IYD" />
                                            <dx:ListEditItem Text="GTH" Value="GTH" />
                                            <dx:ListEditItem Text="IYM" Value="IYM" />
                                            <dx:ListEditItem Text="COM" Value="COM" />
                                            <dx:ListEditItem Text="MYC" Value="MYC" />
                                            <dx:ListEditItem Text="AOS" Value="AOS" />
                                        </Items>
                                        <ValidationSettings ErrorText="Valor inválido">
                                            <RegularExpression ErrorText="Falló la validación de expresión Regular" />
                                        </ValidationSettings>
                                    ...
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="DropDownList_unidad" runat="server" 
                                            SelectedValue='<%# Bind("codigo_unidad") %>' Enabled="False">
                                            <asp:ListItem> </asp:ListItem>
                                            <asp:ListItem>AIM</asp:ListItem>
                                            <asp:ListItem>APD</asp:ListItem>
                                            <asp:ListItem>AIN</asp:ListItem>
                                            <asp:ListItem>AOS</asp:ListItem>
                                            <asp:ListItem>AEC</asp:ListItem>
                                            <asp:ListItem>ASO</asp:ListItem>
                                            <asp:ListItem>CIR</asp:ListItem>
                                            <asp:ListItem>COM</asp:ListItem>
                                            <asp:ListItem>CYA</asp:ListItem>
                                            <asp:ListItem>CPT</asp:ListItem>
                                            <asp:ListItem>CGE</asp:ListItem>
                                            <asp:ListItem>FAR</asp:ListItem>
                                            <asp:ListItem>GAM</asp:ListItem>
                                            <asp:ListItem>GBI</asp:ListItem>
                                            <asp:ListItem>GDO</asp:ListItem>
                                            <asp:ListItem>GFI</asp:ListItem>
                                            <asp:ListItem>GSC</asp:ListItem>
                                            <asp:ListItem>GTH</asp:ListItem>
                                            <asp:ListItem>IYD</asp:ListItem>
                                            <asp:ListItem>IYM</asp:ListItem>
                                            <asp:ListItem>JUR</asp:ListItem>
                                            <asp:ListItem>MYC</asp:ListItem>
                                            <asp:ListItem>PSI</asp:ListItem>
                                            <asp:ListItem>RYF</asp:ListItem>
                                            <asp:ListItem>SFC</asp:ListItem>
                                            <asp:ListItem>SIS</asp:ListItem>
                                            <asp:ListItem>SSR</asp:ListItem>
                                            <asp:ListItem>TEL</asp:ListItem>
                                            <asp:ListItem>UYH</asp:ListItem>
                                        </asp:DropDownList>
                                    </EditItemTemplate>
                                ...
                                <dx:GridViewDataTextColumn Caption="TIPO" FieldName="codigo_tipo" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="DropDownList_tipo" runat="server" 
                                            SelectedValue='<%# Bind("codigo_tipo") %>' Enabled="False">
                                            <asp:ListItem> </asp:ListItem>
